...
//                new AntPathRequestMatcher("/console"),
        ...
        http
            ...
            .and()
                ...
                .antMatchers(HttpMethod.POST, SecurityConstants.CATEGORIES_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.POST, SecurityConstants.SUBCATEGORIES_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.POST, SecurityConstants.SHOPS_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.GET, SecurityConstants.ORDER_URL).access(String.format("hasAnyRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.POST, SecurityConstants.ORDER_URL).access(String.format("hasAnyRole('%s', '%s')", Role.ROLE_ADMIN.toString(), Role.ROLE_BUYER.toString()))
                .antMatchers(HttpMethod.POST, SecurityConstants.SELLERS_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.GET, SecurityConstants.SELLERS_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.POST, SecurityConstants.BUYERS_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
                .antMatchers(HttpMethod.GET, SecurityConstants.BUYERS_URL).access(String.format("hasRole('%s')", Role.ROLE_ADMIN.toString()))
